...
export const Login: React.FC = () => {
  ...
  const fillDemoCredentials = () => {
    setValue('email', 'admin@veridion.com');
    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50 dark:bg-slate-950 transition-colors duration-200">
      ...
      <div className="flex-1 hidden md:flex flex-col justify-between bg-primary-900 text-white p-12 relative overflow-hidden select-none border-r border-primary-950">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <span className="font-bold text-2xl tracking-tight">Veridion</span>
        </div>
        ...
        <div className="relative z-10 flex items-center justify-between text-xs text-primary-200/50">
          <span>&copy; {new Date().getFullYear()} Veridion Inc. All rights reserved.</span>
        ...
        <div className="w-full max-w-sm mx-auto space-y-8">
          <div className="space-y-2 text-left">
            ...
            <div className="flex items-center gap-2 md:hidden mb-6">
              ...
              <span className="font-bold text-lg text-slate-800 dark:text-slate-100">Veridion</span>
            </div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Enter your corporate credentials to access the Veridion portal.
            </p>
          </div>
          ...
          {isDemoCredentialsVisible && (
            <div className="p-3.5 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800 text-left">
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-normal">
                Veridion Phase 1 operates with mock authentication. Click below to auto-fill the demo administrator details:
              </p>
              <button
                onClick={fillDemoCredentials}
                className="mt-2.5 text-[11px] bg-slate-200/60 hover:bg-slate-200 dark:bg-slate-800/80 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold px-2.5 py-1 rounded transition-colors cursor-pointer"
              >
                Fill admin@veridion.com
              </button>
            </div>
          )}
        </div>
