    ...
    <div className="space-y-6 text-left max-w-4xl">
      <div>
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
          Step-by-step guides, frequently asked questions, and help contacts for the Veridion procurement suite.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm space-y-4">
        ...
        <div className="space-y-4 text-xs">
          {[
            { q: 'How does AI extract information from quotations?', a: 'Veridion uses multi-modal OCR systems to capture invoice headers, table items, tax rates, and delivery details directly from raw PDF sheets or scanned images.' },
            ...
            { q: 'How is data security managed?', a: 'Veridion implements multi-factor login (MFA), role-based permissions, and cryptographically signs override audits to ensure transparency.' }
          ].map((faq, idx) => (
      ...
      <div className="p-5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl flex items-center justify-between gap-4 text-xs font-semibold">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-450 font-normal">Contact our systems support team to sync Veridion to SAP or Microsoft Dynamics.</p>
          </div>
        </div>
        <a href="mailto:support@veridion.io" className="text-xs text-primary-600 hover:underline">
          support@veridion.io
        </a>
      </div>
