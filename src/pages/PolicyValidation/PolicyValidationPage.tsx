...
const POLICY_RULES: PolicyRuleEval[] = [
  {
    ...
    explanation: 'Veridion policy mandates that all suppliers have a validated GST identification token matching government ledger APIs. An unverified GSTIN blocks transaction flows.',
