...
const LOCAL_ORG_SETTINGS: OrgSettings = {
  companyName: 'Veridion Procurement Solutions',
  gstNumber: '29ABCDE1234F1Z5',
  address: '124 Business Plaza, Tower A, Bangalore, KA, 560001',
  currency: 'USD',
  timezone: 'Asia/Kolkata (GMT+5:30)',
  financialYear: '2026-2027',
  email: 'admin@veridion.io',
};

const LOCAL_USERS: UserItem[] = [
  { id: 'USR-01', name: 'Sarah Jenkins', email: 'sarah.j@veridion.io', role: 'Administrator', department: 'Procurement', status: 'Active', mfaEnabled: true },
  { id: 'USR-02', name: 'Alex Mercer', email: 'alex.m@veridion.io', role: 'Procurement Officer', department: 'Engineering', status: 'Active', mfaEnabled: true },
  { id: 'USR-03', name: 'Evelyn Shore', email: 'evelyn.s@veridion.io', role: 'Manager', department: 'Finance & HR', status: 'Active', mfaEnabled: false }
];
